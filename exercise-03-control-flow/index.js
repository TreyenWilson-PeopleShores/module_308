...
// (your code here)
if(isLate===true){
    finalScore = submission.submission.score-(submission.submission.score*.1);
}else{
...
switch(true){
    case (assignment.points_possible<=50):
        difficulty="Easy";
        break;
    case (assignment.points_possible>=51 && assignment.points_possible<=100):
        difficulty="Medium";
        break;
    case (assignment.points_possible>=101 && assignment.points_possible<=150):
        difficulty="Hard";
        break;
